        ...
        >
          <Grid container spacing={2}>
            <Grid item xs={12} sm={12} sx={{ wordBreak: "break-word" }}>
              <FormHelperText>
                Descarga el formato para subir tu personal:{" "}
                <a
                  href="http://neocarnets.neoaplicaciones.com/assets/plantilla.csv"
                  download
                >
                  En CSV
                </a>{" "}
                <a
                  href="http://neocarnets.neoaplicaciones.com/assets/plantilla.xlsx"
                  download
                >
                  En XLSX
                </a>
            ...
            <Grid item xs={12} sm={12}>
              ...
              <FormHelperText>
                Nota: Solo se permiten archivos CSV (Comma Separated Values) y
                Excel (XLSX) utilizando el formato especificiado.
              </FormHelperText>
            </Grid>
          </Grid>
          <Button
